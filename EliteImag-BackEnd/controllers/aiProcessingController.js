...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Architectural geometry correction: force all walls, doors, frames, paintings, windows, and furniture edges perfectly straight and aligned; remove tilt and lens distortion; preserve exact structure.`,
