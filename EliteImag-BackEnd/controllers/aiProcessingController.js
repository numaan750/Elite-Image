...
const buildPrompt = (
  ...
  const prompts = {
    ...
    Straighten: `Perfectly straighten interior architecture: level all horizons, make walls/doors/windows fully vertical and parallel, correct wide-angle/perspective distortion naturally, preserve original proportions, details, lighting, and quality.`,
