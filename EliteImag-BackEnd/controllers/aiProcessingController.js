...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Perfect architectural correction: remove fisheye distortion, make all walls, doors, windows, and lines perfectly straight and parallel, natural 50mm perspective, preserve exact scene.`,
