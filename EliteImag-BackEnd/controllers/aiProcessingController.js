...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Object Removal": `Remove objects using feature="${feature}": only edit the selected regions. Erase everything inside them and seamlessly fill with matching surrounding background. Do not change anything outside the regions. Preserve original image quality, lighting, and details. No blur or add new objects.`,
    ...
    "Straighten": `Perfect global geometry correction — 0% tilt, warp, curve, skew, or misalignment anywhere in the image.`,
