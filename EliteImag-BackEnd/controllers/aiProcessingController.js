...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Correct geometry only: perfectly level horizon, straighten all verticals, fix perspective and lens distortion. Preserve original colors, lighting, and details.`,
