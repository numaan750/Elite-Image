...
const buildPrompt = (
  ...
  const prompts = {
    ...
    //  ya ni use ho raha  // "HDR": `Create ONE realistic HDR photo: balanced exposure, sharp details, natural light, no fade, glow, or blur. Then enhance the result to ultra-sharp HD quality, crystal-clear, vibrant, photo-realistic. Remove any blur, softness, or haze. Do NOT add, remove, or change any element.`,
    ...
    //  ya bi ni use ho raha kahin abi  // "Object Removal": `Remove objects using feature="${feature}": only edit the selected regions. Erase everything inside them and seamlessly fill with matching surrounding background. Do not change anything outside the regions. Preserve original image quality, lighting, and details. No blur or new objects. After removal, enhance the full image to ultra-sharp HD quality, crystal-clear, vibrant, photo-realistic. Remove any blur, softness, or haze. Do NOT change any other element.`,
