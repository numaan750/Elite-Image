...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Perfect architectural correction: straighten fisheye distortion, make all walls, doors, windows, and lines perfectly straight, preserve exact scene.`,
