...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Perfect architectural correction: totally remove fisheye distortion, make all walls, doors, windows, and lines perfectly straight, on new objects added to the image.`,
