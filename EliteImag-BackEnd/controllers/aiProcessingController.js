...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Object Removal": `Remove ONLY selected area(s); keep everything else unchanged, enhance clarity and quality, no blur or fade, and do not chnage anything outside the selected area(s).`,
