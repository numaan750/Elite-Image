...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Fix perspective—make vertical lines perfectly straight and horizontals level. Preserve all content, lighting, colors, and details exactly. Only correct tilt, rotation, and distortion.`,
