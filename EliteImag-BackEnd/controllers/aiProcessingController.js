...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Fix keystone/perspective distortion—make all verticals perfectly straight and horizontals level. Correct camera tilt only. Preserve all details, colors, lighting, and geometry; no other edits.`,
