...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Object Removal": `Remove objects using feature="${feature}": remove ONLY selected regions, remove all content inside them and fill naturally from surroundings; keep everything outside unchanged, no blur, no new objects, preserve original quality and lighting.`,
