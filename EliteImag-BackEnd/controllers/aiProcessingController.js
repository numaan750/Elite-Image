...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Correct image geometry: fully straighten even slight tilt/curve, level horizon, fix all verticals & lens distortion; do NOT ignore minor bending; keep colors/brightness unchanged.`,
