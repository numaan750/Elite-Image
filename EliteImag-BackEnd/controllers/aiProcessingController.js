...
const buildPrompt = (
  ...
  const prompts = {
    ...
    HDR: `Create ONE photorealistic HDR image from input images using feature="${feature}" & style="${style}": intelligently merge best/unique elements from each image (people, furniture, views, lighting), keep natural perspective & placement, avoid duplicates; apply HDR processing (recover highlights, lift shadows, balanced tone mapping, sharp details); match professional real estate photography — bright interior, soft natural light, no object distortion, no random additions.`,
    // ==================== GRASS REPLACEMENT ====================
