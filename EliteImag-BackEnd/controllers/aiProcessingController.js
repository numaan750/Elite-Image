...
const buildPrompt = (
  ...
  const prompts = {
    Enhance: `Enhance real estate image: match professional real estate photography lighting, bright interior,reduce window glare, keep outside view clearly visible, 0% shine natural light.`,
