...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `True architectural straighten: fix fisheye/perspective distortion, make all walls, doors, frames, paintings, and edges perfectly straight, preserve exact objects and layout.`,
