...
const buildPrompt = (
  ...
  const prompts = {
    ...
    "Straighten": `Remove all fisheye/barrel distortion, straighten all verticals and horizontals, fix perspective, preserve scene exactly as if shot with a normal 50mm lens.`,
