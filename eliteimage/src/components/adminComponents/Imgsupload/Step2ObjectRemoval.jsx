    ...
    <div className="w-full min-h-screen bg-white mt-10 sm:mt-8 lg:mt-3">
      ...
      <div className="mb-4 sm:mb-5 lg:mb-6">
        <div className="bg-[#D3E7F0] border-2 border-[#6FB6D6] rounded-2xl p-4 sm:p-6">
          ...
          <div
            className="relative w-full bg-white rounded-[40px] overflow-hidden cursor-crosshair h-32 sm:h-36 lg:h-40"
          ...
          >
            <Image
              ...
              className="w-full h-32 sm:h-36 lg:h-40 object-contain select-none"
              draggable={false}
              priority
            />
