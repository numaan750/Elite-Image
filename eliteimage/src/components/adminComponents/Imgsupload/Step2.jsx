...
const Step2 = ({ formData, setFormData, next, back, featureType }) => {
  ...
  return (
    <div className="w-full min-h-screen bg-white px-4 sm:px-6 lg:px-12 py-4 sm:py-6 lg:py-8">
      ...
      <h2 className="mt-4 sm:mt-5 mb-4 sm:mb-6 text-xl sm:text-2xl lg:text-3xl font-semibold text-gray-900">
        {featureData.title}
      </h2>
      ...
      <div className="mt-8 sm:mt-10 lg:mt-12 flex justify-center lg:justify-end max-w-7xl mx-auto">
        <button
          onClick={handleContinue}
          disabled={!selected}
          className={`flex items-center gap-2 bg-[#034F75] hover:bg-[#023a5c] text-white text-sm sm:text-base px-6 sm:px-8 py-2.5 sm:py-3 rounded-lg transition-colors ${
